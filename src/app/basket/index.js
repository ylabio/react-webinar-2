...
function Basket(){
  ...
  const renders = {
    itemBasket: useCallback(item => <ItemBasket item={item} link={`/articles/${item._id}`} onRemove={callbacks.removeFromBasket} language={select.language} onClick={callbacks.closeModal}/>, []),
  }
