export const renderPagination = (allPages, currentPage) => {
  ...
  if (allPages <= 5)
    for (let i = 2; i < allPages; i++) arrPage.push(i)
  if (currentPage <= 2 && allPages > 5)
    for (let i = 2; i <= 3; i++) arrPage.push(i)
  if (currentPage > allPages - 2 && allPages > 5)
    for (let i = allPages - 2; i < allPages; i++) arrPage.push(i)
  if (currentPage > 2 && currentPage <= allPages - 2 && allPages > 5)
